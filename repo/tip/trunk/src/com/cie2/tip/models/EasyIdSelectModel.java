 ...
 */
public class EasyIdSelectModel<T> extends AbstractSelectModel {
	 ...
	 * 
	 */
	public EasyIdSelectModel(List<T> list, Class<T> clazz, String labelField, String idField, PropertyAccess access) {
		if (clazz == null) {
